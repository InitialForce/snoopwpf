...
/// <summary>
/// Unit tests for <see cref="ExecuteCommandTool"/>.
/// </summary>
[TestFixture]
public class ExecuteCommandToolTests
{
    ...
    private ExecuteCommandTool tool = null!;

    [SetUp]
    public void SetUp()
    {
        this.fake = new FakeSnoopInspector();
        this.tool = new ExecuteCommandTool(this.fake);
    }
    ...
    {
        this.fake.OnExecuteCommand = (nodeId, ct) =>
        ...
        var json = await this.tool.ExecuteCommandAsync("0:5");
    ...
    public async Task ForwardsNodeId_ToInspector()
    {
        ...
        await this.tool.ExecuteCommandAsync("0:7");
    ...
    public void MutationDisabled_ThrowsMcpException()
    {
        ...
        var ex = Assert.ThrowsAsync<McpException>(
            () => this.tool.ExecuteCommandAsync("0:1"));
    ...
    public void Cancellation_ThrowsOperationCanceledException()
    {
        ...
        this.fake.OnExecuteCommand = (_, ct) =>
        {
        ...
        Assert.ThrowsAsync<OperationCanceledException>(
            () => this.tool.ExecuteCommandAsync("0:1", ct: cts.Token));
    }
    ...
    public async Task JsonOutput_UsesCamelCaseKeys()
    {
        ...
        var json = await this.tool.ExecuteCommandAsync("0:1");
